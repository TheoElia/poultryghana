 ...
 */
! function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("https://frost.dexignzone.com/xhtml/error-404.html")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e(t.bootstrap = {}, t.jQuery, t.Popper)
}(this, function(t, e, c) {
    "use strict";
...
var Frost = function() {
    var e = $(window).width(),
        t = new Date;
    monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], t.setMonth(t.getMonth() + 1), WebsiteLaunchDate = t.getDate() + " " + monthNames[t.getMonth()] + " " + t.getFullYear();
    var o = function() {
            if (jQuery(".countdown-timer").length > 0) {
                var e = new Date("Jan 25 2021 17:02:37");
                e = e.getTime();
                var t = new Date;
                t = t.getTime();
                var o = new Date("Dec 31 2022 17:02:37");
                o = o.getTime(), $(".countdown-timer").final_countdown({
                    start: e / 1e3,
                    end: o / 1e3,
                    now: t / 1e3,
                    selectors: {
    ...
    return {
        init: function() {
            $(".heart").on("click", function() {
                ...
                }(WebsiteLaunchDate), o(), jQuery("body").append('\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"><\/script>'), jQuery(".openbtn").on("click", function() {
                ...
                }), $("#kenburn").length > 0 && $("#kenburn").slippry({
                    transition: "kenburns",
                    useCSS: !0,
                    speed: 8e3,
                    pause: 3e3,
                ...
                function() {
                    if ($(".parallax").length > 0) {
                        ...
                        $(document).on("mousemove", function(o) {
                            ...
                            var n = o.pageY - t;
                            t = o.pageY, $(".parallax div").each(function(e, t) {
                                var o = (e + 1) * (.015 * a),
                                    s = (e + 1) * (.015 * n),
                                    r = $(t).position().left + o,
                                    i = $(t).position().top + s;
                                $(t).css("left", r + "px"), $(t).css("top", i + "px")
                            })
                        })
                    }
        ...
        load: function() {
            $(".content").length > 0 && ($(".content").hasClass("scroll-off") ? e > 900 && $(".content").mCustomScrollbar({
                setWidth: !1,
                setHeight: !1,
                axis: "y"
...
jQuery(document).ready(function() {
    ...
    Frost.load(), setTimeout(function() {
...
! function(e) {
    ...
    ! function(t) {
        var o = "function" == typeof define && define.amd,
            ...
            i = "https://frost.dexignzone.com/xhtml/error-404.html";
...
jQuery(window).on("load", function() {
    jQuery(".styleswitcher-right").animate({
        right: "-100%",
        left: "auto"
    }), jQuery(".switch-btn").addClass("closed"), handleLanguageTranslation()
}), $(function() {
    "use strict";
    addSwitcher(), jQuery(".switch-btn").on("click", function() {
        jQuery(".styleswitcher-right").toggleClass("active"), jQuery(this).hasClass("open") ? (jQuery(this).addClass("closed").removeClass("open"), jQuery(".styleswitcher-right").animate({
            right: "-100%"
        }, 200)) : jQuery(this).hasClass("closed") && (jQuery(this).addClass("open").removeClass("closed"), jQuery(".styleswitcher-right").animate({
            right: "-0"
        }, 200))
    })
});